...
**10,718/370 → 6,445/271 → 6,401 → 6,162 → 6,128 → 6,096 → 5,749 → 5,744 → 5,058 → 3,992**
(post archive, fix1-6 scale, AGENTS badge clearance on main, and this batch).
...
## Fix batch 6 scale (this PR)

| Probe | Result |
|-------|--------|
| Before (canonical command, branch from `main`) | **5,058** / **271** (Linting: 272) |
| Batch | **35** live docs (26-35 errors) → **0** issues |
