# ECRR Automation Suite - Deployment Completion Summary
...
### 3. Import SigNoz Dashboard
```powershell
pwsh -File scripts/import-signoz-dashboard.ps1
```

### 4. Configure SigNoz Alert Rules
- Open http://localhost:8080 → Alerts → Create Alert Rule
- Add: `ecrr_compliance_four_section_pct < 95` (Warning)
- Add: `ecrr_compliance_gate_pct < 90` (Critical)
...
The ECRR automation suite has been successfully deployed with:
...
*Deployment completed by ECRR Automation Suite*  
