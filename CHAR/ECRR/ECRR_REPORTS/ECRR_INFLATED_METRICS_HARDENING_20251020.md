...
**File:** `CHAR/ECRR/ECRR_REPORTS/EVIDENCE_TEMPLATE.md`
...
3. `CHAR/ECRR/ECRR_REPORTS/EVIDENCE_TEMPLATE.md` — Measurement framework
4. `CHAR/ECRR/ECRR_REPORTS/ECRR_INFLATED_METRICS_REMEDIATION_20251020.md` — Phase 1 report
5. `CHAR/ECRR/ECRR_REPORTS/ECRR_INFLATED_METRICS_HARDENING_20251020.md` — This report (Phase 2)
