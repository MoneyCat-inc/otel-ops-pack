...
- `CHAR/ECRR/ECRR_REPORTS/ECRR_GATE_RUN_LATEST.md` — Latest run symlink (needs commit)
...
2. **Stage Gate Evidence**:
   ```bash
   git add CHAR/ECRR/ECRR_REPORTS/ECRR_GATE_RUN_20251015_053452.md
   git add CHAR/ECRR/ECRR_REPORTS/ECRR_GATE_RUN_20251015_073616.md
   git add CHAR/ECRR/ECRR_REPORTS/ECRR_GATE_READY_FINAL_20251015_073616.md
   ```
