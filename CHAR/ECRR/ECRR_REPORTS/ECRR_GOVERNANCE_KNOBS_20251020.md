...
/CHAR/ECRR/ECRR_REPORTS/ @BossCat @audit-team
...
**Outputs:**
- `CHAR/ECRR/ECRR_REPORTS/EVIDENCE_YYYY-MM-DD.md` (from template)
...
**See evidence →** [EVIDENCE_YYYY-MM-DD.md](CHAR/ECRR/ECRR_REPORTS/EVIDENCE_YYYY-MM-DD.md)
```
...
1. ✅ Use template: `CHAR/ECRR/ECRR_REPORTS/EVIDENCE_TEMPLATE.md`
