...
# Phase 1: Clean temp directories
...
foreach ($dir in $tempDirs) {
    if (Test-Path $dir) {
        ...
        try {
            ...
            Get-ChildItem $dir -Recurse -Force -ErrorAction SilentlyContinue | Remove-Item -Force -ErrorAction SilentlyContinue
...
# Phase 2: Clean cache directories
...
# Phase 3: Clean Windows Update cache
...
if (Test-Path $updateCache) {
    ...
    try {
        ...
        Get-ChildItem $updateCache -Recurse -Force -ErrorAction SilentlyContinue | Remove-Item -Force -ErrorAction SilentlyContinue
