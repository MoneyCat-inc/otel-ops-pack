# Cursor OTLP Wiring Agent Startup Script
# Specialized agent for otlp-wiring

param(
    [string]$AgentId = "cursor-otlp-wiring-agent",
    [string]$TaskId = "TASK-20250925-041324-500",
    [switch]$DryRun = $false,
...
Write-Host "🚀 Starting Cursor OTLP Wiring Agent" -ForegroundColor Green
Write-Host "📋 Specialization: otlp-wiring" -ForegroundColor Cyan
