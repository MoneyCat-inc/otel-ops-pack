# Corrected Health Check Script for Observability Pipeline
# Usage: pwsh -File scripts/health-check-observability-corrected.ps1

Write-Host "=== Observability Pipeline Health Check (Corrected) ===" -ForegroundColor Cyan
Write-Host "Timestamp: 2025-09-28 16:27:40" -ForegroundColor White
