...
# RAW COMMAND OUTPUTS - 2025-09-30 05:14:26

## 1. Queue Steward Status Check
```bash
pnpm agent:status
```
...
📊 Agent Queue Status
══════════════════════════════════════════════════
⏰ Timestamp: 2025-09-30T04:05:28.545Z
🔒 Lock Present: NO
⚙️  Driver: json
👻 Shadow Mode: OFF
📋 Queue Depth: 2
...
## 2. Health Log Export Verification
```bash
...
**Output:**
```
{"timestamp":"2025-09-30T04:05:24.4701717+00:00","dataset":"agent_queue","queueLength":1,"readyCount":1,"pendingCount":0,"pendingByLane":{"unknown":0},"readyByLane":{"unknown":1},"lastRun":"2025-09-28T05:58:17Z","lastError":null,"killSwitch":false,"jobsProcessed":8,"agentName":"cursor-agent-observability-copilot","uptime":0,"lanes":{"pending":0,"avgPriority":0.0,"ready":1,"type":"unknown","total":1,"prioritySum":0},"config":{"retryBackoff":"exponential","defaultTtl":86400000,"maxConcurrency":1}}
```

## 3. SigNoz Health Endpoint
```bash
...
**Output:**
```
✅ SigNoz health endpoint accessible - no errors returned
```

## 4. Canary Test Execution
```bash
.\canary-test.ps1
```
...
[OK] Sent OTLP trace (http://localhost:14318/v1/traces)
...
**Validation Completed By**: Cursor Agent - Observability Copilot
**Validation Date**: 2025-09-30 05:22:28 UTC
