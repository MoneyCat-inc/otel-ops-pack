...
export function ScenarioCard({ 
  ...
  return (
    <div 
      ...
      className={`rounded-lg border-2 p-6 transition-all duration-200 ${getStatusColor()}`}
    >
      ...
      <div className="flex space-x-3">
        {!isRecording && !result && (
          <button
            ...
            disabled={!isActive}
            className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed font-medium transition-colors focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        ...
        {isRecording && (
          <button
            ...
            className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium transition-colors focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
        ...
        {result && (
          <button
            ...
            className="flex-1 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 font-medium transition-colors focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
