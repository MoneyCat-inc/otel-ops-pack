...
> **SUPERSEDED IN PART by the CHARTER (correction 2026-09-02).** The *Self-Merge Conditions* under
> *Merge Authority Policy* and the five *Approved Lanes* below are historical. `docs/BossCat/CHARTER.md`
> governs: the machine operator `@fubumaki` is the **only** seat that merges; no agent seat, BossCat OEM
> included, self-merges under any condition; lanes are the docs lane and the code lanes described in
> `docs/AGENTS.md`. Identity, ECRR discipline, budgets (≤10 files / ≤200 LOC) and the kill-switch still
> apply. Body left as the v1.1 record.
...
### **Approved Lanes Only** (v1.1 list — superseded by `docs/AGENTS.md` lanes)
...
#### **Self-Merge Conditions** (NEW in v1.1 — RESCINDED by the CHARTER, see notice above)
