...
1. **Configure GitHub App authentication** (follow `GITHUB_AUTHENTICATION_SETUP.md`)
2. **Address Dependabot alerts** (5 vulnerabilities: 3 high, 2 moderate)
3. **Monitor nightly dashboard exports**
4. **Rotate any remaining secrets** per schedule
