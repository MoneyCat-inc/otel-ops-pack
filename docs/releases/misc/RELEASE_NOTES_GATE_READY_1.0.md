...
This release establishes the **local-first gate verification infrastructure** for Resonai [OTel], including automated watchdog guardians for the Windows OpenTelemetry Collector.
